...
- Documentation structure with ADR, resources, and weekly-logs folders
- Written ADR template and first frontend ADR (React + TypeScript + Next.js)
- Created comprehensive project description with risks analysis and link collection
- Documented all course deadlines and deliverables in structured format
- Documented course objectives and expectations
- Established weekly tracking structure with separate checklist and summary files
...
- Begin planning booking system schema and workflow processes
- Populate GitHub project backlog with tasks
- Write additional ADRs
- Continue project planning and milestone definition
- Write comprehensive README.md as project overview and documentation entry point
- Start FastAPI backend setup with basic project structure
- Create initial Next.js frontend with basic routing
