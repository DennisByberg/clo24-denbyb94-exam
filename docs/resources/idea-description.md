...
- **Next.js, Mantine, Tanstack Query** - (frontend)
...
- **Problem:** May take longer to learn than I think
- **Solution:** Structured learning plan, weekly milestones, find good tutorials

### Risk: Next.js learning curve

- **Problem:** Larger learning curve than expected
- **Solution:** Start with basic Next.js tutorials, compare with vanilla React concepts I already know

### Risk: Azure App Service deployment

- **Problem:** Limited experience with deployment
- **Solution:** Start locally with Docker, then prod environment when I feel confident and test step by step
...
> **Marcus Medina Ramirez** • Personal Campus Mölndal • Oct 28
>
> Sounds like a good plan, next.js isn't that scary to get into, I think python might feel more confusing. Go hard with SRP and it will work out.
